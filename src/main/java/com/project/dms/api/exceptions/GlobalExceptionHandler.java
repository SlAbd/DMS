...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleColisNotFoundException(ColisNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> handleBordereauNotFoundException(BordereauNotFoundException ex, WebRequest request) {
        Map<String, Object> response = new HashMap<>();
        response.put("timestamp", LocalDateTime.now());
        response.put("status", HttpStatus.NOT_FOUND.value());
        response.put("error", "Not Found");
